...
class Settings(BaseSettings):
    ...
    @property
    def portals_example_path(self) -> Path:
        """Path to bundled portals example configuration."""
        return self.data_dir / "portals.example.yml"

    @property
    def portals_config_path(self) -> Path:
        """Path to active portals scanner configuration."""
        return self.data_dir / "portals.yml"

    @property
    def scan_history_path(self) -> Path:
        """Path to portal scan history TSV."""
